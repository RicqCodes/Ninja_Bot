...
export default function AddToAndriodChrome(props: Props) {
  const { closePrompt } = props;

  return (
    <div className="fixed top-0 left-0 right-0 h-[60%] z-50 pt-12 px-4 text-white font-sans">
      ...
      <div className="relative bg-primary p-4 h-full rounded-xl flex flex-col justify-around items-center text-center">
        ...
        <div className="flex gap-2 items-center text-lg">
          <p className="font-sm">Click the</p>
          <HiDotsVertical className="text-4xl" />
          <p>icon</p>
        </div>
        <div className="flex flex-col gap-2 items-center text-lg w-full px-4">
          <p>Scroll down and then click:</p>
          <div className="bg-zinc-50 flex justify-center items-center w-full px-4 py-2 rounded-lg text-zinc-900 gap-2">
